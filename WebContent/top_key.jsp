...
<link href="file:///E|/apache-tomcat-6.0.18/webapps/IBSDDS/style.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
<div id="wrapper"> 
  <!-- end #menu -->
  <p>&nbsp;</p><div id="header">
	...
	<tr><td height="38"><font size="2"><b><a hre"file:///e|/apache-tomcat-6.0.18/webapps/ibsdds/index.html"><b>Home</b></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="file:///e|/apache-tomcat-6.0.18/webapps/ibsdds/login.jsp"><b>Login</b></a></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="file:///e|/apache-tomcat-6.0.18/webapps/ibsdds/owner.jsp"><b>Back</b></a></b></font></td></tr>
...
Integer ee=(Integer)session.getAttribute("id");
	...
	String term=(String)session.getAttribute("term");
      ...
      <tr> 
			...
			<td> 
              <font color="#000000"><%=term%></font>
            </td>
			<td> 
              <font color="#000000"><a  href="request.jsp"><b>Request_TopKey*</b></a></font>
            </td>
             </tr>
...
PreparedStatement ps1=con1.prepareStatement("insert into topkey(fname,uid,uname,uemail) values('"+term+"','"+ee+"','"+name+"','"+email+"')");
ps1.executeUpdate();
