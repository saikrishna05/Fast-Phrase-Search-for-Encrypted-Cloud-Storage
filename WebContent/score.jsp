...
<div id="wrapper"> 
  ...
  <p>&nbsp;</p><div id="header">
	...
	<tr><td height="38"><font size="2"><b><a href="index.html"><b>Home</b></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="login.jsp"><b>Login</b></a></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="owner.jsp"><b>Back</b></a></b></font></td></tr>
	  ...
	  <tr><td colspan="6" align="center"><p><font size="2" color="#009966"><b>View 
          ...
          <td><font  color="#CC0099" size="2"><b>Keyword</b></font></td>
		  <td><font  color="#CC0099" size="2"><b>Assign Score</b></font></td>
...
PreparedStatement ps=con.prepareStatement("select  fid,uid,fname,uname,keyword1 from up");
...
s6=rs.getString(5);
 %>
	...
	<td> 
			...
			<td><font color="#000000"><a href="assign.jsp?<%=s%>"><b>Assign</b></a></font></td>
			 </tr>
          <%
