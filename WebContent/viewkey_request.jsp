	...
	<tr><td height="38"><font size="2"><b><a href="index.html"><b>Home</b></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="login.jsp"><b>Login</b></a></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cloud.jsp"><b>Back</b></a></b></font></td></tr>
	  ...
	  <tr><td colspan="6" align="center"><p><font size="2" color="#000000"><b>View 
		  ...
		  <td><font  color="#CC0099" size="2"><b>File_Name</b></font></td>
		   <td><font  color="#CC0099" size="2"><b>Status</b></font></td>
		 <td><font  color="#CC0099" size="2"><b>Permission_Granted</b></font></td>
...
PreparedStatement ps=con.prepareStatement("select  uid,uname,uemail,fname,status from topkey");
...
while(rs.next())
 ...
 session.setAttribute("s",s);
  s1=rs.getString(2);
   s2=rs.getString(3);
   session.setAttribute("emaill",s2);
   System.out.println(s2);
    s3=rs.getString(4);
	session.setAttribute("fname",s3);
	s4=rs.getString(5);
 ...
 %>
	...
	<td> 
             <font color="#000000"><%=s4%></font>
            </td>
			<td> 
             <font color="#000000"><a href="pick.jsp?<%=s3%>">Granted</a></font>
            </td>
